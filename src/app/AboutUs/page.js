...
const AboutUs = () => {
  return (
    <div className="bg-gray-700 min-h-screen">
      ...
      <div className="py-20 px-8"> {/* Increased padding for height */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12"> {/* Increased gap between cards */}
          ...
          <div className="bg-gray-50 p-10 rounded-lg shadow-lg text-center"> {/* Increased padding */}
            ...
            <h2 className="text-xl font-semibold mb-2 text-blue-500">Strong Relationships</h2>
          ...
          <div className="bg-gray-50 p-10 rounded-lg shadow-lg text-center"> {/* Increased padding */}
            ...
            <h2 className="text-xl font-semibold mb-2 text-blue-500">Excellence At Work</h2>
            <p className="text-gray-500">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-10 rounded-lg shadow-lg text-center"> {/* Increased padding */}
            ...
            <h2 className="text-xl font-semibold mb-2 text-blue-500">Innovation & Creativity</h2>
            <p className="text-gray-500">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
            </p>
          </div>
      ...
      <div className="p-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-blue-500">Meet Our Team</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              />
              <h2 className="text-xl font-semibold text-blue-500">{member.name}</h2>
